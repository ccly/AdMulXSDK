...
static NSString * _Nonnull const OctLoaderCsjInters = @"OctCsjExpInterstitialAd";
...
static NSString * _Nonnull const OctLoaderCsjVideo = @"OctCsjRewardVideoAd";
...
static NSString * _Nonnull const OctLoaderGdtInters = @"OctGdtExpInterstitialAd";
//static NSString * _Nonnull const OctLoaderGdtDraw = @"OctGdtDrawAd";
//static NSString * _Nonnull const OctLoaderGdtDrawCustom = @"OctGdtDrawCustomAd";
static NSString * _Nonnull const OctLoaderGdtVideo = @"OctGdtRewardVideoAd";
static NSString * _Nonnull const OctLoaderGdtSplash = @"OctGdtSplashAd";
//static NSString * _Nonnull const OctLoaderGdtFsVideo = @"OctGdtFullScreenAd";
static NSString * _Nonnull const OctLoaderGdtBanner = @"OctGdtBannerAd";
//static NSString * _Nonnull const OctLoaderCsjCustomFlow = @"OctGdtFlowCustomAd";
static NSString * _Nonnull const OctLoaderGdtFlow = @"OctGdtFlowAd";

static NSString * _Nonnull const OctLoaderKsInters = @"OctKsExpInterstitialAd";
//static NSString * _Nonnull const OctLoaderKsDraw = @"OctKsDrawAd";
static NSString * _Nonnull const OctLoaderKsVideo = @"OctKsRewardVideoAd";
