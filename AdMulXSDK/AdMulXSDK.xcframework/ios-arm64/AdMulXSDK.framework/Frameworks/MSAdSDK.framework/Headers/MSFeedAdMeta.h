...
- (NSString * _Nullable)metaVideoUrl;//信息流视频（已废弃）
 ...
 */
- (MSAdInteractionType)metaAdInteractionType;//广告点击交互(仅美数渠道支持该配置)

- (UIImageView * _Nullable)metaShakeTwistImageView;//摇一摇或扭一扭图标 注意广告交互为摇一摇或扭一扭才存在该图标(仅美数渠道支持该配置)
