...
extern NSString *const kMeiShuConfigOldADValueKey;
extern NSString *const kMeiShuConfigOldADVersionKey;
extern NSString *const kMeiShuConfigNewADValueKey;
extern NSString *const kMeiShuConfigNewADVersionKey;
...
/**
 屏蔽策略注意事项⚠️
 1、以下参数为全局参数，一经设置，所有广告类型都将生效（仅屏蔽美数平台下广告），当再次设置，上一次设置将会失效。
...
/**
 性别:(-1:未知、男:01、女:10)
 */
@property(nonatomic,assign,class,getter=getGender)MSGender gender;
/**
