 ...
 *
 */
- (void)msNativeFeedAdLoadedSuccess:(MSNativeFeedAd *)nativeFeedAd feedAds:(NSArray <MSNativeFeedAdModel *> *)feedAds;
/**
 *  新原生广告加载广告数据失败回调
 */
- (void)msNativeFeedAdLoadedFail:(MSNativeFeedAd *)nativeFeedAd withError:(NSError *)error;
/**
 *  新原生广告渲染或者展示失败
 */
- (void)msNativeFeedAdFail:(MSNativeFeedAd *)nativeFeedAd feedAd:(MSNativeFeedAdModel *)feedAd extInfo:(NSDictionary *)info error:(NSError *)error;
/**
 *  广告素材渲染成功回调
 */
- (void)msNativeFeedAdRenderSuccess:(MSNativeFeedAd *)nativeFeedAd feedAd:(MSNativeFeedAdModel *)feedAd;
/**
 ...
 *  新原生广告即将展现
 */
- (void)msNativeFeedAdExposure:(MSNativeFeedAdModel *)feedAd;
/**
 *  广告被点击
 */
