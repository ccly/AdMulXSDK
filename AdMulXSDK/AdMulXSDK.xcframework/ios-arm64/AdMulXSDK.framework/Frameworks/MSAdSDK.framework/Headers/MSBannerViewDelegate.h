 ...
 */
- (void)msBannerLoadedSuccess:(MSBannerView *)msBannerAd;
/**
 * 请求广告失败后调用
 */
- (void)msBannerLoadedFail:(MSBannerView *)msBannerAd error:(NSError *)error;
/**
   广告渲染成功
 */
 ...
 * banner广告曝光
 */
- (void)msBannerExposure:(MSBannerView *)msBannerAd;
/**
 *  banner条点击回调
 */
