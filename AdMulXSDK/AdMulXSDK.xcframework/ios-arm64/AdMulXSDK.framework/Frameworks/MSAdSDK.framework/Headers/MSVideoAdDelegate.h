 ...
 */
- (void)msVideoLoadedSuccess:(MSVideoAd *)videoAd;
/**
 *  视频广告加载失败
 */
- (void)msVideoLoadedFail:(MSVideoAd *)videoAd error:(NSError *)error;
/**
 * 广告渲染成功回调 可以进行展示
 */
- (void)msVideoAdRenderSuccess:(MSVideoAd *)videoAd extInfo:(NSDictionary *)info;
/**
 *  视频广告成功展示
 */
- (void)msVideoExposure:(MSVideoAd *)videoAd;
/**
    视频广告渲染或者展示失败
 */
-(void)msVideoAdFail:(MSVideoAd *)videoAd extInfo:(NSDictionary *)info error:(NSError *)error;
/**
 *  视频广告点击回调
 */
