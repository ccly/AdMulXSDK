...
//isUniAppAdapter=NO， 使用方法showAdsInViewController展示广告，实现这个回调octad_splashBottomView，同时isShowBottomView=YES，才能展示bottomView
 ...
 */
- (UIView *)octad_splashBottomView:(OctAdSplash *)splashAd;
