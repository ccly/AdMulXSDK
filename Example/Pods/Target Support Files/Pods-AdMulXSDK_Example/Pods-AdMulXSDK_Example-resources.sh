...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/CJLYAdSDK/CJLYAdSDK/Assets/LY_AdSDK.bundle"
  install_resource "${PODS_ROOT}/CJLYAdSDK/CJLYAdSDK/Assets/XrsImage.bundle"
  install_resource "${PODS_ROOT}/CJMobileAd/CJMobileAd/Assets/CJMobileAd.bundle"
